...
export const CryptoWallets = () => {
  ...
  useEffect(() => {
    if (missingEthWallet) {
      setError('Please install an ethereum chrome extension, such as Metamask, to test this feature.')
    }
  }, [missingEthWallet])
  ...
  return (
    <div className="container">
      <div className="column">
        ...
        Crypto wallets allow users to hold digital assets, like cryptocurrencies and NFTs, and easily cryptographically
        authenticate themselves on a blockchain. Our Crypto wallets product allows your users to seamlessly authenticate
        to your application via MetaMask or any other Ethereum based crypto wallet.
        <br/><br/>
        {!missingEthWallet && <>
          <button disabled={missingEthWallet} onClick={authenticateWithErrorHandling}>Authenticate with Crypto Wallet.
          </button>
        </>}
        <br/>
        {status}
